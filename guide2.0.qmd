...
### Once you've found data you're interested in
...
::: {.callout-question collapse="true" style="background-color: #f9f9f9; border-left: 5px solid #dc3545; padding: 15px; margin: 15px 0; color: #343a40;"}
### Getting started with your first organization
...
point_count_data <- data.frame(
  ...
  Description = c(
    ...
    "Number of individuals observed: 1-10, TMTT (too many to tag), CI1, CI2, CI3 (for amphibians).",
