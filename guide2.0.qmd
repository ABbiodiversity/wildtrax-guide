...
### Default privacy settings {#sec-location-privacy-settings}

An organization can control aspects of the [locations](#sec-locations) it manages. 

The default buffering of all the locations it manages.

“Allow location reports” creates links you can share with external audiences (e.g., collaborators or landowners) without giving them organizational privileges or unwieldy information.

The visit image access field controls global access to your visit images.

Human blurring is an organization-wide setting for the type of users for which the auto-tagger will blur humans detected in images, if any. The options include “Blur for anonymous users (if applicable),” “Blur for non-admins,” and “Blur for everyone”. See the section on Human blurring for more information.
...
### Organization memmbership {#sec-organization-membership}
