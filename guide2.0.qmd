...
-   **Projects**: Projects are groups of specific media to address research questions or implement study designs. Projects can be one of three sensors: [ARUs](#sec-aru-projects), [cameras](#sec-camera-projects) or [point counts](#sec-point-count-projects).
...
-   **Define Your Questions**\
    What research questions or objectives do you want this project to address? Clarity here will guide your data setup and analysis.\
-   **Determine Your Upload Strategy**\
    Are you uploading acoustic recordings at the project level or at the organization level? Choose the approach that aligns with your workflow.\
-   **Set Membership Privileges**\
    What access levels (e.g., read-only, admin) are required for project participants? Assign roles accordingly.\
-   **Establish Location Privacy**\
    Do you need public, restricted, or private location settings? Consider the privacy needs of your data.

*For more guidance, refer to [Accounts, membership and permissions](#sec-permissions).*
:::
...
To begin, click **Choose a Folder to Upload**, select the directory containing your recordings, and let WildTrax scan the files. Once scanning is complete, you can proceed to the next step. In the next step, optionally enter spatial coordinates for new locations or update missing coordinates. This can also be done later using [location sync](#sec-location-sync). Note, if a location doesn’t exist in the organization, WildTrax will create it through the upload process.
...
Recommended equipment The following equipment is recommended for processing acoustic data. Proper equipment will enhance your experience and data quality using WildTrax.

Computer with stable, high-speed internet connection and a minimum screen size of 15” Headphones with the following specifications: Stereo Circumaural (fully enclosing the ear) Minimum frequency response: 20 – 20000 Hz No bass boost (flat frequency response) Contact WildTrax Info regarding headphone specifications if you are unsure if your headphones meet specifications.
